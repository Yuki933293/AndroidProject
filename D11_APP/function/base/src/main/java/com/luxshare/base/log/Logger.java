    ...
    public static void d(String tag, String msg) {
        if (enableLog(Log.DEBUG)) {
            if (tag == null) {
                ...
                sILogger.log(Log.DEBUG, sTag + tag, msg, null);
            }
        }
    }
    ...
    public static void i(String tag, String msg) {
        if (enableLog(Log.INFO)) {
            if (tag == null) {
                ...
                sILogger.log(Log.INFO, sTag + tag, msg, null);
            }
        }
    }
    ...
    public static void w(String tag, String msg) {
        if (enableLog(Log.WARN)) {
            if (tag == null) {
                ...
                sILogger.log(Log.WARN, sTag + tag, msg, null);
            }
        }
    }
    ...
    public static void e(String tag, String msg) {
        if (enableLog(Log.ERROR)) {
            if (tag == null) {
                ...
                sILogger.log(Log.ERROR, sTag + tag, msg, null);
            }
        }
    }
